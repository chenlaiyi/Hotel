 ...
 * @Last Modified time: 2023-03-26 12:00:11
 */
namespace addons\diandi_place\models\searchs\marketing;
use addons\diandi_place\models\marketing\PlaceRecharge;
use common\components\DataProvider\ArrayDataProvider;
use yii\base\Model;
use yii\data\Pagination;
/**
 * PlaceRechargeSearch represents the model behind the search form of `addons\diandi_place\models\PlaceRecharge`.
 */
class PlaceRechargeSearch extends PlaceRecharge
{
    /**
     * {@inheritdoc}
     */
