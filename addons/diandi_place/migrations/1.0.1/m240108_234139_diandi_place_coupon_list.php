...
class m240108_234139_diandi_place_coupon_list extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->createTable('{{%diandi_place_coupon_list}}', [
            ...
            'PRIMARY KEY (`id`)'
        ], "ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='卡券消费记录表'");
        /* 索引设置 */
        /* 表数据 */
        $this->insert('{{%diandi_place_coupon_list}}',['id'=>'1','bloc_id'=>'51','store_id'=>'150','create_time'=>'0000-00-00 00:00:00','update_time'=>'0000-00-00 00:00:00','member_id'=>'2','coupon_name'=>'2','coupon_type'=>'2','coupon_id'=>'2','order_id'=>'2','price'=>'2']);
        /* 设置外键约束 */
