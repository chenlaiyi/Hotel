...
class m240108_234139_diandi_place_invoice extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->createTable('{{%diandi_place_invoice}}', [
            ...
            'PRIMARY KEY (`id`)'
        ], "ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='订单开票'");
        /* 索引设置 */
        /* 表数据 */
        $this->insert('{{%diandi_place_invoice}}',['id'=>'1','bloc_id'=>'0','store_id'=>'0','create_time'=>'0000-00-00 00:00:00','update_time'=>'0000-00-00 00:00:00','order_id'=>'3444','status'=>'1','invoice_url'=>'2','company'=>'2','social_code'=>'2','phone'=>'2','email'=>'2','member_id'=>'2','type'=>'1','bank'=>'2','bank_address'=>'2','company_address'=>'2','taxpayer_no'=>'2']);
        /* 设置外键约束 */
