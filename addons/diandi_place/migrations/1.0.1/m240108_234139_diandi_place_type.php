...
class m240108_234139_diandi_place_type extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->insert('{{%diandi_place_type}}',['id'=>'18','title'=>'民宿','template_type'=>'3','bloc_id'=>'91','store_id'=>'153','create_time'=>'2023-06-21 13:27:26','update_time'=>'2023-06-29 15:06:43','is_default'=>'0']);
        ...
        $this->insert('{{%diandi_place_type}}',['id'=>'24','title'=>'棋牌室','template_type'=>'5','bloc_id'=>'91','store_id'=>'153','create_time'=>'2023-07-08 23:59:13','update_time'=>'2023-07-08 23:59:13','is_default'=>'0']);
        /* 设置外键约束 */
