...
class m231213_063915_diandi_place_room_status extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->createTable('{{%diandi_place_room_status}}', [
            ...
            'roomdate' => "datetime NULL DEFAULT '0000-00-00 00:00:00' COMMENT '房价日期'",
            'thisdate' => "datetime NULL DEFAULT '0000-00-00 00:00:00' COMMENT '当天日期'",
