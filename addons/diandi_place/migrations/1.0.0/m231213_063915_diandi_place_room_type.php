...
class m231213_063915_diandi_place_room_type extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->createTable('{{%diandi_place_room_type}}', [
            ...
            'cate_id' => "int(11) NOT NULL COMMENT '全局房型分类'",
