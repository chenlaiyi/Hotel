...
class m231213_063915_diandi_place_recharge_list extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->createTable('{{%diandi_place_recharge_list}}', [
            ...
            'pay_time' => "datetime NULL DEFAULT '0000-00-00 00:00:00' COMMENT '支付时间'",
            ...
            'PRIMARY KEY (`id`)'
        ], "ENGINE=InnoDB  DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='会员充值记录'");
        /* 索引设置 */
        /* 表数据 */
