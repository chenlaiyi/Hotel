...
class m231213_063915_diandi_place_coupon extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->createTable('{{%diandi_place_coupon}}', [
            ...
            'use_start' => "datetime NULL DEFAULT '0000-00-00 00:00:00' COMMENT '时间限制-开始时间'",
            'use_end' => "datetime NULL DEFAULT '0000-00-00 00:00:00' COMMENT '时间限制-结束时间'",
            'enable_start' => "datetime NULL DEFAULT '0000-00-00 00:00:00' COMMENT '有效期开始时间'",
            'enable_end' => "datetime NULL DEFAULT '0000-00-00 00:00:00' COMMENT '有效期结束时间'",
