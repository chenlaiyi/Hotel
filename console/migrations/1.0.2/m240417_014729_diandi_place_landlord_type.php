...
class m240417_014729_diandi_place_landlord_type extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->createTable('{{%diandi_place_landlord_type}}', [
            ...
            'PRIMARY KEY (`id`)'
        ], "ENGINE=MyISAM  DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='房东业务类型'");
        ...
        $this->insert('{{%diandi_place_landlord_type}}',['id'=>'404','bloc_id'=>'91','store_id'=>'153','member_id'=>'544','type_id'=>'22','type_status'=>'1','user_id'=>'0','create_time'=>'2024-01-09 12:36:10','update_time'=>'2024-01-09 12:36:10']);
        $this->insert('{{%diandi_place_landlord_type}}',['id'=>'403','bloc_id'=>'91','store_id'=>'153','member_id'=>'544','type_id'=>'24','type_status'=>'0','user_id'=>'0','create_time'=>'2024-01-09 12:36:10','update_time'=>'2024-01-09 12:36:10']);
        $this->insert('{{%diandi_place_landlord_type}}',['id'=>'402','bloc_id'=>'91','store_id'=>'153','member_id'=>'544','type_id'=>'23','type_status'=>'0','user_id'=>'0','create_time'=>'2024-01-09 12:36:10','update_time'=>'2024-01-09 12:36:10']);
        $this->insert('{{%diandi_place_landlord_type}}',['id'=>'401','bloc_id'=>'91','store_id'=>'153','member_id'=>'544','type_id'=>'18','type_status'=>'0','user_id'=>'0','create_time'=>'2024-01-09 12:36:10','update_time'=>'2024-01-09 12:36:10']);
        $this->insert('{{%diandi_place_landlord_type}}',['id'=>'400','bloc_id'=>'91','store_id'=>'153','member_id'=>'544','type_id'=>'15','type_status'=>'0','user_id'=>'0','create_time'=>'2024-01-09 12:36:10','update_time'=>'2024-01-09 12:36:10']);
        $this->insert('{{%diandi_place_landlord_type}}',['id'=>'469','bloc_id'=>'98','store_id'=>'296','member_id'=>'544','type_id'=>'24','type_status'=>'1','user_id'=>'83','create_time'=>'2024-02-27 15:09:44','update_time'=>'2024-02-27 15:09:44']);
        $this->insert('{{%diandi_place_landlord_type}}',['id'=>'468','bloc_id'=>'98','store_id'=>'296','member_id'=>'544','type_id'=>'23','type_status'=>'1','user_id'=>'83','create_time'=>'2024-02-27 15:09:44','update_time'=>'2024-02-27 15:09:44']);
        $this->insert('{{%diandi_place_landlord_type}}',['id'=>'467','bloc_id'=>'98','store_id'=>'296','member_id'=>'544','type_id'=>'22','type_status'=>'1','user_id'=>'83','create_time'=>'2024-02-27 15:09:44','update_time'=>'2024-02-27 15:09:44']);
        $this->insert('{{%diandi_place_landlord_type}}',['id'=>'466','bloc_id'=>'98','store_id'=>'296','member_id'=>'544','type_id'=>'18','type_status'=>'1','user_id'=>'83','create_time'=>'2024-02-27 15:09:44','update_time'=>'2024-02-27 15:09:44']);
        $this->insert('{{%diandi_place_landlord_type}}',['id'=>'465','bloc_id'=>'98','store_id'=>'296','member_id'=>'544','type_id'=>'15','type_status'=>'1','user_id'=>'83','create_time'=>'2024-02-27 15:09:44','update_time'=>'2024-02-27 15:09:44']);
