...
class m240417_014729_user_account extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->createTable('{{%user_account}}', [
            ...
            'PRIMARY KEY (`id`)'
        ], "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='会员_账户统计表'");
        
        /* 索引设置 */
        $this->createIndex('bloc_id','{{%user_account}}','bloc_id, store_id, user_id',1);
        $this->createIndex('member_id','{{%user_account}}','user_id',0);
