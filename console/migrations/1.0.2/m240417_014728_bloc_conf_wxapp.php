...
class m240417_014728_bloc_conf_wxapp extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->createTable('{{%bloc_conf_wxapp}}', [
            ...
            'share_title' => "varchar(50) NULL",
            'share_path' => "varchar(100) NULL",
            'share_image' => "varchar(255) NULL",
            'create_time' => "int(11) NULL",
            'update_time' => "int(11) NULL",
            'PRIMARY KEY (`id`)'
        ], "ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='公司小程序配置'");
