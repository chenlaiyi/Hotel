...
class m240417_014729_diandi_place_recharge_list extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->createTable('{{%diandi_place_recharge_list}}', [
            ...
            'PRIMARY KEY (`id`)'
        ], "ENGINE=InnoDB  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='会员充值记录'");
        
        /* 索引设置 */
        
        
        /* 表数据 */
        $this->insert('{{%diandi_place_recharge_list}}',['id'=>'1','bloc_id'=>'0','store_id'=>'0','create_time'=>'2024-03-21 12:07:27','update_time'=>'2024-03-21 12:07:27','member_id'=>'2','recharge_id'=>'2','price'=>'2.00','balance'=>'2.00','pay_time'=>'2023-04-11 10:50:59','transaction_id'=>'2','order_number'=>'2','status'=>'2']);
