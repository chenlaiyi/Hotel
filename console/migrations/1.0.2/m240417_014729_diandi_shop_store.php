...
class m240417_014729_diandi_shop_store extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        /* 创建表 */
        $this->createTable('{{%diandi_shop_store}}', [
        ...
        /* 索引设置 */
        $this->createIndex('bloc_id','{{%diandi_shop_store}}','bloc_id',1);
    ...
    public function down()
    {
        $this->execute('SET foreign_key_checks = 0');
        /* 删除表 */
        $this->dropTable('{{%diandi_shop_store}}');
        $this->execute('SET foreign_key_checks = 1;');
    }
}
