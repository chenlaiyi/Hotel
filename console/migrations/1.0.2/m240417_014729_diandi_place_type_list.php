...
class m240417_014729_diandi_place_type_list extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->createTable('{{%diandi_place_type_list}}', [
            ...
            'PRIMARY KEY (`id`)'
        ], "ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='全局房型'");
        ...
        $this->insert('{{%diandi_place_type_list}}',['id'=>'30','place_type_id'=>'18','title'=>'一室','bloc_id'=>NULL,'store_id'=>NULL,'create_time'=>NULL,'update_time'=>NULL]);
        $this->insert('{{%diandi_place_type_list}}',['id'=>'31','place_type_id'=>'18','title'=>'二室','bloc_id'=>NULL,'store_id'=>NULL,'create_time'=>NULL,'update_time'=>NULL]);
        $this->insert('{{%diandi_place_type_list}}',['id'=>'32','place_type_id'=>'18','title'=>'三室','bloc_id'=>NULL,'store_id'=>NULL,'create_time'=>NULL,'update_time'=>NULL]);
        $this->insert('{{%diandi_place_type_list}}',['id'=>'33','place_type_id'=>'18','title'=>'四室及以上','bloc_id'=>NULL,'store_id'=>NULL,'create_time'=>NULL,'update_time'=>NULL]);
        $this->insert('{{%diandi_place_type_list}}',['id'=>'34','place_type_id'=>'22','title'=>'单间','bloc_id'=>NULL,'store_id'=>NULL,'create_time'=>NULL,'update_time'=>NULL]);
        $this->insert('{{%diandi_place_type_list}}',['id'=>'35','place_type_id'=>'22','title'=>'LOFT','bloc_id'=>NULL,'store_id'=>NULL,'create_time'=>NULL,'update_time'=>NULL]);
        $this->insert('{{%diandi_place_type_list}}',['id'=>'36','place_type_id'=>'22','title'=>'一房一厅','bloc_id'=>NULL,'store_id'=>NULL,'create_time'=>NULL,'update_time'=>NULL]);
        $this->insert('{{%diandi_place_type_list}}',['id'=>'37','place_type_id'=>'22','title'=>'两房以上','bloc_id'=>NULL,'store_id'=>NULL,'create_time'=>NULL,'update_time'=>NULL]);
        $this->insert('{{%diandi_place_type_list}}',['id'=>'38','place_type_id'=>'23','title'=>'豪包','bloc_id'=>NULL,'store_id'=>NULL,'create_time'=>NULL,'update_time'=>NULL]);
        $this->insert('{{%diandi_place_type_list}}',['id'=>'39','place_type_id'=>'23','title'=>'中包','bloc_id'=>NULL,'store_id'=>NULL,'create_time'=>NULL,'update_time'=>NULL]);
        $this->insert('{{%diandi_place_type_list}}',['id'=>'40','place_type_id'=>'23','title'=>'大包','bloc_id'=>NULL,'store_id'=>NULL,'create_time'=>NULL,'update_time'=>NULL]);
        $this->insert('{{%diandi_place_type_list}}',['id'=>'41','place_type_id'=>'23','title'=>'普包','bloc_id'=>NULL,'store_id'=>NULL,'create_time'=>NULL,'update_time'=>NULL]);
