...
class m240417_014728_ai_sms_log extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->createTable('{{%ai_sms_log}}', [
            ...
            'PRIMARY KEY (`id`)'
        ], "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='公用_短信发送日志'");
        
        /* 索引设置 */
        $this->createIndex('error_code','{{%ai_sms_log}}','error_code',0);
