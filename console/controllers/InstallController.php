...
EOF;
        ...
        $dirs = ['api/runtime/', 'public/runtime/', 'public/assets/', 'public/attachment', 'admin/runtime/', 'api/web/store/'];
        ...
        Console::input('nginx配置后，需要将/public/backend/pro-admin/configs/configs.js 中的接口域名和站点域名都配置为自己的域名');
        return  true;
    }
}
