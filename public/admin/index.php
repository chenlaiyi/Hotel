 ...
 * @Last Modified time: 2023-07-18 14:56:01
 */

$localIp = require __DIR__ . '/../../common/config/localIp.php';

defined('DOTENV_PATH') or define('DOTENV_PATH', dirname(__DIR__, 2));
...
\yiithings\dotenv\Loader::load(DOTENV_PATH, DOTENV_FILE);
