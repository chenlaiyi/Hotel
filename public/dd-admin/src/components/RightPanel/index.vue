  ...
  <div ref="rightPanel" :class="{ show: show }" class="rightPanel-container">
    ...
    <div class="rightPanel">
      <div class="rightPanel-setting-list">
        <div
          class="handle-button"
          :style="{ top: buttonTop + 'px', 'background-color': '#ebf5ff',color :'#191B5C' }"
          @click="tabRight(0)"
        >
      ...
      <div class="rightPanel-items">
        ...
        <slot v-if="showIdx === 1" name="store" @hidePanels="hidePanel" />
        <!-- <slot /> -->
      </div>
    </div>
  </div>
  ...
  methods: {
    ...
    tabRight(index) {
      if (index === 0 || index === 1) {
        ...
        this.show = false
        this.$router.push({ name: 'addons-addons-index' })
      } else if (index === 3) {
        this.show = false
