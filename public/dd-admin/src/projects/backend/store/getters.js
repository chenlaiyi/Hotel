 ...
 * @Last Modified time: 2024-07-30 20:55:03
 */
const getters = {
  ...
  addonsTitle: state => state.settings.addonsTitle,
  plugins: state => state.settings.plugins,
  Layout: state => state.settings.Layout,
  showTopNav: state => state.settings.showTopNav,
  ...
  isRegister: state => state.settings.isRegister
}
