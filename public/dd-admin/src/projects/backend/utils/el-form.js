 ...
 * @Last Modified time: 2025-02-09 06:37:48
 */
import Vue from 'vue'
...
import { enumsBlocs, enumsStores, enumsStoresbloc } from '@projectName/api/Enums'
...
// 注册 公司联动 组件
Vue.component('cascade-select', cascadeSelect)
// 注册 bmap 组件
...
Vue.use(EleForm, {
  ...
  // 选择商户
  'cascader-store': {
    action: store.getters.elForm.enumsStores
    // 配置 cascader-store 的默认属性
    // options: getStoreList()
  },
  // 选择公司
  'cascader-bloc': {
    action: store.getters.elForm.enumsBlocs
    // 配置 cascader-bloc 的默认属性
    // options: getBlocList()
  },
  'cascader-bloc-store': {
    action: store.getters.elForm.enumStoresBloc
    // 配置 cascader-bloc 的默认属性
    // options: getStoreBloc()
  }
})
