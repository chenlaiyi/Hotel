          ...
          >
            <el-col :span="24" class="table-name">
              ...
              <el-col :md="14" :xs="24" :xl="14" :lg="14">
                ...
                <el-col :span="1">
                  <div class="btn-use el-button--warning" @click="uninstallAddons(item)">关闭</div>
                </el-col>
              </el-col>
            </el-col>
          </el-card>
...
import { ManageUninstall } from '@projectName/views/system/api/addons/manage.js'
...
export default {
  ...
  methods: {
    ...
    uninstallAddons: function(item) {
      ManageUninstall(item).then((response) => {
