...
import {
  ...
  getBlocstatus,
  getLevels
} from '@projectName/views/system/api/addons/bloclevel.js'
  ...
  data() {
    return {
      ...
      filterInfo: {
        ...
        fieldList: [
          { label: '等级名称', type: 'input', value: 'BlocLevel[name]' },
          { label: '等级', type: 'select', value: 'BlocLevel[level_num]', list: 'level_num' }
        ]
      },
      listTypeInfo: {
        level_num: this.initLevels()
      },
      // 检索 end
      tableKey: 0,
      formInline: {
