 ...
 * @property-read array $memberInfo
 * @property-read \yii\db\ActiveQuery $member
 * @property-read \yii\db\ActiveQuery $memberGroup
...
class DdApiAccessToken extends ActiveRecord implements IdentityInterface, RateLimitInterface
{
    ...
    {
        return [
            [['group_id', 'status', 'allowance', 'allowance_updated_at', 'create_time', 'updated_time', 'login_num','member_id'], 'integer'],
