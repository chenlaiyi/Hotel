 ...
 * @Last Modified time: 2025-06-21 00:18:39
 */
...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function getUserRole(): \yii\db\ActiveQuery
    {
     ...
     */
    public function signup($username, $mobile, $email, $password, int $status = 0, bool $is_create_bloc = false, string $invitation_code = '', int $source_type = 0, string $company = '', $customer_id = 0): array|bool
    {
