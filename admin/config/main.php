 ...
 * @Last Modified time: 2025-07-15 19:56:33
 */
$params = array_merge(
...
return [
    ...
    'modules'             => [
        ...
        // 公众号
        'officialaccount' => [
            'class' => 'common\modules\officialaccount\module',
        ],
        'customer'        => [
            'class' => 'admin\modules\customer\site',
        ],
        //微信开放平台
        'openWeixin'      => [
            'class' => 'common\modules\openWeixin\module',
        ],
    ],
    'language'            => 'zh-CN',
    'components'          => [
        ...
        'response'    => [
            ...
            //                'defaultMsg'    => 'error',
            //            ],
            'as beforeSend' => 'common\behaviors\BeforeSend',
        ...
        'log'         => [
            ...
            'targets'    => [
                [
                    ...
                    'categories' => ['yii\db\Command::query', 'application', 'yii\redis\Command::execute'],
                ],
            ],
        ],
        'authManager' => [
            ...
            'rules'               => [
                ...
                [
                    ...
                    'extraPatterns' => [
                        'POST,GET index'      => 'index',
                        'POST ceshi'          => 'ceshi',
                        'POST,GET storemenus' => 'storemenus',
                ...
                [
                    ...
                    'extraPatterns' => [
                        ...
                        'POST,GET oss'        => 'oss',
                        'POST,GET api'        => 'api',
                        'POST,GET site-color' => 'site-color',
                    ],
                ],
                // 扩展模块
                [
                    ...
                    'extraPatterns' => [
                        ...
                        'POST create'      => 'create',
                        'POST update'      => 'update',
                        'POST auth-bloc'   => 'auth-bloc',
                        'GET bloc-list'    => 'bloc-list',
                        'GET all'          => 'all',
                        'POST auth'        => 'auth',
                ...
                [
                    ...
                    'extraPatterns' => [
                        ...
                        'GET addons'                              => 'addons',
                        'POST create'                             => 'create',
                        'POST permission/<id>'                    => 'permission',
                        'POST permission-list/<id>'               => 'permission-list',
                        'POST  route'                             => 'route',
                        'POST,PUT update/<id>'                    => 'update',
