...
use common\plugins\diandi_auth\models\AuthMemberPermission as AuthMemberPermissionModel;
use yii\base\Model;
 ...
 */
class AuthMemberPermission extends AuthMemberPermissionModel
{
...

    {
        ...
        $query = ZyjMemberPermissionModel::find();
