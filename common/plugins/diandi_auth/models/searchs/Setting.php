...
use common\plugins\diandi_auth\models\Setting as SettingModel;
use yii\base\Model;
use yii\data\Pagination;

/**
 * Setting represents the model behind the search form of `common\plugins\diandi_auth\models\Setting`.
 */
class Setting extends SettingModel
{
     ...
     * @return array|bool
     */
    public function searchStore(array $params): array|bool
    {
        $query = SettingModel::find();
