 ...
 */
class AuthMemberListRole extends \common\components\ActiveRecord\YiiActiveRecord
{
    ...
    public function rules(): array
    {
        ...
        return [
            [['bloc_id', 'store_id', 'accountId', 'roleId','user_id','member_id'], 'integer'],
    ...
    function getRole()
    {
        return $this->hasOne(AuthMemberRole::class, ['id' => 'roleId']);
    }

    public function getUser()
    {
        return $this->hasOne(AuthMemberList::class, ['id' => 'member_id']);
    }
