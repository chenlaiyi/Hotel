 ...
 */
class MemberRole extends \common\components\ActiveRecord\YiiActiveRecord
{
    ...
    public function rules(): array
    {
        ...
        return [
            [['bloc_id', 'store_id', 'accountStoreId', 'accountCloudId', 'status','spec','is_cloud','is_boss','is_bd','is_dz','level'], 'integer'],
