 ...
 */
class WebsiteProCustomer extends \common\components\ActiveRecord\YiiActiveRecord
{
    use StoreTrait;
    ...
    public function rules(): array
    {
        return [
            ...
            ['solution_id', 'exist', 'targetClass' => 'common\plugins\diandi_website\models\Solution', 'targetAttribute' => 'id', 'message' => '指定解决方案不存在', 'when' => function ($model) {
