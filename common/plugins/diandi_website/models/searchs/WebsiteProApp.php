...
use common\plugins\diandi_website\models\WebsiteProApp as WebsiteProAppModel;
...
/**
 * WebsiteProApp represents the model behind the search form of `common\plugins\diandi_website\models\WebsiteProApp`.
 */
