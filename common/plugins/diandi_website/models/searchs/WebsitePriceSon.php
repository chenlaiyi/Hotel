...
/**
 * WebsitePriceSon represents the model behind the search form of `common\plugins\diandi_website\models\WebsitePriceSon`.
 */
class WebsitePriceSon extends WebsitePriceSonModel
{
    /**
     * {@inheritdoc}
     */
