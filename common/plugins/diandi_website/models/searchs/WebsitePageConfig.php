...
/**
 * WebsitePageConfig represents the model behind the search form of `common\plugins\diandi_website\models\WebsitePageConfig`.
 */
class WebsitePageConfig extends WebsitePageConfigModel
{
    /**
     * {@inheritdoc}
     */
