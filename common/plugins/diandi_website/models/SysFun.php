 ...
 */
class SysFun extends \common\components\ActiveRecord\YiiActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules(): array
    {
        return [
            ...
            [['icon'], 'string', 'max' => 180],
            [['des'], 'string', 'max' => 450],
            ['cate_id', 'exist', 'targetClass' => 'common\plugins\diandi_website\models\SysFunCate', 'targetAttribute' => 'id', 'message' => '指定分类不存在'],
        ];
    }
