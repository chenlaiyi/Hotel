...
use common\plugins\diandi_website\models\Menu;
use common\plugins\diandi_website\models\searchs\Menu as MenuSearch;
use Yii;
...
{
    public string $modelSearchName = "MenuSearch";
