...
{
    use \common\plugins\diandi_website\components\ResultServicesTrait;


    public static function getSlide($pageInfo = [],int $page_id = 0)
    {
        return self::baseList(WebsiteSlide::find()->where(['page_id' => $page_id]), $pageInfo);
    }
