 ...
 * @property \addons\diandi_ota\components\douyin\catergroupbuy\Application   $microMerchant 小微商户实例
 */
class Wechat extends Component
{
    ...
    {
        if (!self::$_microMerchant instanceof \addons\diandi_ota\components\douyin\catergroupbuy\Application) {
