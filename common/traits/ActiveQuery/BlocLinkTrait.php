...
trait BlocLinkTrait
{
    ...
    public function beforeSave($insert): bool
    {
        ...
        $business_name = Yii::$app->request->input('business_name',$member_id.'的公司');
        ...
        $provinceCityDistrict = Yii::$app->request->input('provinceCityDistrict',[0,0,0]);
        $address = Yii::$app->request->input('address','具体地址');
        $register_level = Yii::$app->request->input('register_level');
        $longitude = Yii::$app->request->input('longitude','0.000000');
        $latitude = Yii::$app->request->input('latitude','0.000000');
        $telephone = Yii::$app->request->input('telephone','0');
