...
class BaseService extends Component implements DdSubscriberInterface
{
    ...
    {
        list($serverObjname, $method) = explode(':', $name);
        if (class_exists('addons\\'.$serverObjname)) {
            ...
            $event = new DdHandleAddonsMethodEvent($serverObj, $method, $params[0]);
     ...
     * @return void
     */
    private function changeNamespace(): void
    {
     ...
     * @return string
     */
    private function combineClassName(): string
    {
