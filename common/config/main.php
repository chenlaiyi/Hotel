...
return [
    ...
    'version' => '1.0.2',
    'aliases' => [
        '@bower' => dirname(__DIR__, 2) . '/public/resource/lib',
        '@npm' => dirname(__DIR__, 2) . '/public/node_modules',
    ...
    'modules' => [
        ...
        'diandi_senangpay' => [
            'class' => 'common\plugins\diandi_senangpay\site',
        ]
    ],
    'bootstrap' => [
        'common\middlewares\UserLoader',
        'common\middlewares\Loader',
        'common\middlewares\EventLoader',
        'queue',
    ],
    'components' => [
        'request' => [
