...
$config = [
    'components' => [
        'fans' => [
            'class' => 'common\modules\officialaccount\components\Fans'
        ],
        'officialaccount' => [
            'class' => 'common\modules\officialaccount\components\wechat'
        ]
    ],
    'params' => [
        // token有效期是否验证 默认不验证
        ...
        'wechatConfig' => [
            ...
            'oauth' => [
                'scopes' => ['snsapi_login'],
                'callback' =>  Yii::$app->request->input('redirect_uri','/store/#/dashboard'),
            ],
        ],
