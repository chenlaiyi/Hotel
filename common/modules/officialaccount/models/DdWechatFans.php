 ...
 */
class DdWechatFans extends \common\components\ActiveRecord\YiiActiveRecord
{
    use StoreTrait;
    ...
    {
        return '{{%officialaccount_wechat_fans}}';
    }
    ...
    {
        return [
            [['member_id', 'openid', 'nickname', 'fans_info'], 'required'],
            [['member_id', 'update_time', 'create_time', 'gender','groupid'], 'integer'],
            [['fans_info'], 'string'],
    ...
    // 根据用户id获取信息
    public static function getFansByUid($member_id): ?DdWechatFans
    {
