...
class QrcodeController extends AController
{
     ...
     */
    public function actionCreateQrcode(): array|string
   {
        ...
        $directory = Yii::getAlias('@public/attachment/wxappcode/'.$module_name.'/'.$bloc_id.'/'.$store_id.'/'.$baseInfo['member_id']);
        ...
        return ResultHelper::json(400, '获取失败',['response'=>$response]);
    }
}
