 ...
 *
 * @property int|mixed|null $credit5
 * @property int|mixed|null $credit4
 * @property int|mixed|null $credit3
 * @property int|mixed|null $credit2
 * @property int|mixed|null $credit1
 * @property int|mixed|null $consume_integral
 * @property int|mixed|null $frozen_money
 * @property int|mixed|null $consume_money
 * @property int|mixed|null $give_money
 * @property int|mixed|null $accumulate_money
 * @property int|mixed|null $user_money
 * @property int|mixed|null $level
 * @property int|mixed|null $status
 * @property array|mixed|null $member_id
 * @public int $id
 ...
 */
class DdMemberAccount extends \common\components\ActiveRecord\YiiActiveRecord
{
    /**
     * {@inheritdoc}
     */
