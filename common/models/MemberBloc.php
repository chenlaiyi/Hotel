 ...
 */
class MemberBloc extends \common\components\ActiveRecord\YiiActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['member_id', 'bloc_id', 'status', 'is_default'], 'integer'],
    ...
    {
        return $this->hasMany(UserStore::className(), ['member_id' => 'member_id']);
    }
