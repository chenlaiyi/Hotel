<template>
	<view class="msg-item" v-if="!msg.isDelete">
		...
		<view :class="{reverse:!msg.isAi}">
			<view class="userInfo">
				<image class="avatar 123" :src="msg.isAi?'../../static/uni-ai.png':'../../static/avatar.png'" mode="widthFix"></image>
			</view>
			<view class="content">
...
<script>
	...
	import uniDateformat from '../uni-dateformat/uni-dateformat.vue'
	...
	export default {
		...
		computed: {
			msgContent() {
				console.log('msgContent',this.msg)
				if(typeof this.msg.content === 'object' && this.msg.content.type === 'chat'){
					return this.msg.content.message
				}
				return false
			},
			nodes() {
