 ...
 * @Last Modified time: 2022-04-11 14:29:28
 */
// router.js
...
router.beforeEach((to, from, next) => {
	...
	if(!fui.iglobal.isUndefined(from.query.member_id) && !fui.iglobal.isNull(from.query.member_id) && from.query.member_id != ''){
