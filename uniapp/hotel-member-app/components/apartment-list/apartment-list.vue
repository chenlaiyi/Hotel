<template>
	<view>
		<view v-for="(item,ins) in apartmentList" :key="ins">
			...
			<!-- 列表 -->
			<view class="">
				<apartment-item :apartmentList="item.list" @getHotels="getCommonIndex('hotList', 3)"></apartment-item>
			</view>
		</view>
...
<script>
	export default {
		...
		created() {
			this.getCommonIndex('apartmentList', 3)
		},
		methods: {
			hideWish(){
