<template>
	<view class="fui-numberbox">
		<view class="fui-numbox-icon fui-icon-reduce " :class="[disabled || min>=value?'fui-disabled':'']" @tap="reduce"
			:style="{color:iconColor,fontSize:iconSize+'rpx'}"></view>
		<input type="number" v-model="inputValue" :disabled="disabled" @blur="blur" class="fui-num-input"
		...
		<view class="fui-numbox-icon fui-icon-plus" :class="[disabled || value>=max?'fui-disabled':'']" @tap="plus"
			:style="{color:iconColor,fontSize:iconSize+'rpx'}"></view>
	</view>
</template>
