<template>
	<view class="fui-datetime-picker">
		<view class="fui-mask" :class="{ 'fui-mask-show': isShow }" @touchmove.stop.prevent="stop" catchtouchmove="stop" @tap="hide"></view>
		<view class="fui-header" :class="{ 'fui-show': isShow }">
			<view class="fui-picker-header" :class="{ 'fui-date-radius': radius }" @touchmove.stop.prevent="stop" catchtouchmove="stop">
				<view class="fui-btn-picker" :style="{ color: cancelColor }" hover-class="fui-opacity" :hover-stay-time="150"
				 @tap="hide">取消</view>
				<view class="fui-btn-picker" :style="{ color: color }" hover-class="fui-opacity" :hover-stay-time="150" @tap="btnFix">确定</view>
			</view>
			...
			<view class="fui-picker-body">
				<picker-view :value="value" @change="change" class="fui-picker-view">
					<picker-view-column v-if="!reset && (type < 4 || type == 7)">
						<view class="fui-column-item" :class="{ 'fui-font-size_32': !unitTop && type == 7 }" v-for="(item, index) in years"
						 :key="index">
							{{ item }}
					...
					<picker-view-column v-if="!reset && (type < 4 || type == 7)">
						<view class="fui-column-item" :class="{ 'fui-font-size_32': !unitTop && type == 7 }" v-for="(item, index) in months"
						 :key="index">
							{{ formatNum(item) }}
					...
					<picker-view-column v-if="!reset && (type == 1 || type == 2 || type == 7)">
						<view class="fui-column-item" :class="{ 'fui-font-size_32': !unitTop && type == 7 }" v-for="(item, index) in days"
						 :key="index">
							{{ formatNum(item) }}
					...
					<picker-view-column v-if="!reset && (type == 1 || type == 4 || type == 5 || type == 7)">
						<view class="fui-column-item" :class="{ 'fui-font-size_32': !unitTop && type == 7 }" v-for="(item, index) in hours"
						 :key="index">
							{{ formatNum(item) }}
					...
					<picker-view-column v-if="!reset && (type == 1 || type > 3)">
						<view class="fui-column-item" :class="{ 'fui-font-size_32': !unitTop && type == 7 }" v-for="(item, index) in minutes"
						 :key="index">
							{{ formatNum(item) }}
					...
					<picker-view-column v-if="!reset && type > 4">
						<view class="fui-column-item" :class="{ 'fui-font-size_32': !unitTop && type == 7 }" v-for="(item, index) in seconds"
						 :key="index">
							{{ formatNum(item) }}
